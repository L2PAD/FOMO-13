...
/**
 * Unified FOMO badge glyph library.
 * Single house style: crisp white line-art glyph rendered on a blue hexagon.
 * >=30 base glyphs the admin can pick from. All future badges MUST reuse this set.
 */

// Inner SVG children for each glyph (white stroke, 24x24 canvas).
export const BADGE_GLYPHS: Record<string, React.ReactNode> = {
  ...
  medal: (<><path d="M8 3 6 8M16 3l2 5" /><circle cx="12" cy="15" r="5" /><path d="M12 12.5v0M11 15.5l1 1 1.5-2" /></>),
...
// Legacy seed icon keys -> canonical glyph keys (so existing DB badges look right).
