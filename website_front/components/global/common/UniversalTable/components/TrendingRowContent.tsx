...
const TrendingRowContent = ({ item }: UniversalTableCaseProps) => {
  ...
  return (
    <>
      ...
      <div className="row-default-value">DeSci</div>
      <div className="row-bold-value">${simplifyAmount(Number(item.price || 0), 2)}</div>
...
export default TrendingRowContent;
