...
const InfluenceDiscordRowContent = ({ item }: UniversalTableCaseProps) => {
  return (
    <>
      <ProjectData
        style={{
      ...
      <div style={{ fontSize: "14px", color: "#070B35", fontWeight: "var(--font-weight-regular)" }}>{item.onlineNow}</div>
      <div>
        <EngagementBadge level={item.engagementLevel || "medium"} />
      </div>
      <div>
        <RedFlag
...
export default InfluenceDiscordRowContent;
