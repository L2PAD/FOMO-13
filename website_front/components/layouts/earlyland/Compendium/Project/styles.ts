...
export const TimelineItemWrapper = styled(BaseCard)`
...
export const TimelineFooterWrapper = styled.div`
  font-weight: var(--font-weight-regular);
  font-size: 12px;
  line-height: 14px;
  color: var(--color-text-muted);
...
export const RollupContentWrapper = styled.div`
  p {
    font-weight: var(--font-weight-regular);
    font-size: 18px;
    line-height: 21px;
...
export const RollupHelpButton = styled.button`
...
export const RollupNextButton = styled.button<{ isDone: boolean }>`
  font-weight: var(--font-weight-semibold);
  font-size: 16px;
  line-height: 19px;
  color: var(--color-white);
