...
import MyCartModal from "../modals/MyCartModal";
import TabsInfo3 from "./TabsInfo";
import {
  ActionsUser,
  ActionsUserTitle,
  ActionsUserWrapper,
...
const items = [
  ...
  { title: "SharkRace Club", link: "/nfts/project/234" },
  { title: "SharkRace Club NFT", link: "/nfts/card/234" },
];
          ...
          <div>
            ...
            <ActionsWrapper>
              ...
              <ButtonsWrapper>
                ...
                <OrderButton onClick={() => setCartModal(true)}>
                  + Make order
                </OrderButton>
              </ButtonsWrapper>
            </ActionsWrapper>
