...
import { LinkIcon, TwitterIcon } from "../../../../../global/Icons";
...
import {
  ...
  Wrapper,
} from "../../../Projects/Project/Overview/styles";
...
import AddressTopEntitiesModal from "../../../modals/AddressTopEntitiesModal";
...
import AddressInflowModal from "../../../modals/AddressInflowModal";
import {
  AddAlerts,
  AlertsTitle,
  AlertsWrapper,
...
const tabs = ["Hot contracts", "Holdings", "Inflow", "Outflow"];
...
const AddressTab = () => {
  ...
  const [topEntitiesModal, setTopEntitiesModal] = useState(false);
    ...
    <div>
      ...
      <CardsWrapper>
        <CardWrapper variant="default">
          <CardTitleWrapper>
            <p>Top entities</p>
            <Link href="onchain/visualize">Visualize</Link>
          </CardTitleWrapper>
          <UserWrapper>
            <UserAvatar
              size="medium"
            ...
            <div>
              <UserTitleWrapper>
                <p>KuCoin</p>
                <a href="components/layouts/projects/Onchain/Tabs/Address#">
              ...
              <UserDescriptionWrapper value={-8.44}>
                <p>$386,436,281.01</p>
                <span>-$8.44 MM</span>
              </UserDescriptionWrapper>
            </div>
          ...
          <UsersScoreUserButton onClick={() => setTopEntitiesModal(true)}>
            See all &gt;
          </UsersScoreUserButton>
        </CardWrapper>
        <CardWrapper variant="default">
          <CardTitleWrapper>
            <p>Filter for transactions</p>
          </CardTitleWrapper>
          <CardsTableContent>
            <TransactionsTableHeader>
              <div>Time</div>
          ...
          <UsersScoreUserButton onClick={() => setFilterTransactionModal(true)}>
            See all &gt;
          </UsersScoreUserButton>
        </CardWrapper>
      </CardsWrapper>
      <AlertTitleWrapper>
        <p>Coing listing alert</p>
        <span>Get notified when a new coin is listed on an exchange</span>
      </AlertTitleWrapper>
      <GraphicWrapper>
        <div className="chart">
          <ReactApexChart
        ...
        <div>
          <AlertsWrapper variant="default">
            <AlertsTitle>Alerts</AlertsTitle>
            <AddAlerts onClick={() => setAlertModal(true)}>
              + Create alert
            </AddAlerts>
          </AlertsWrapper>
      ...
      <div>
        ...
        <TableWrapper variant="default">
          <TableContent>
            ...
            <UsersScoreUserButton onClick={() => setInflowModal(true)}>
              See all &gt;
            </UsersScoreUserButton>
          </TableContent>
        </TableWrapper>
      ...
      <CommentBlock />
      {alertModal && <CreateAlertModal onClose={() => setAlertModal(false)} />}
      {topEntitiesModal && (
        <AddressTopEntitiesModal onClose={() => setTopEntitiesModal(false)} />
      )}
      {filterTransactionModal && (
        <FilterTransactionsModal
          onClose={() => setFilterTransactionModal(false)}
        />
      )}
      {inflowModal && (
        <AddressInflowModal
          onClose={() => setInflowModal(false)}
          activeTab={activeTab}
        />
      )}
    </div>
