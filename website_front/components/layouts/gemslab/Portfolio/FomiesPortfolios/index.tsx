...
// import { ProjectDataContext } from '../../../../../../pages/crypto/project/[id]'
...
const FomiesPortfolios = () => {
  return (
    <Wrapper>
      <h2>Explore Fomies’ portfolios</h2>
      <Assets>
        {assets.map((item, i) => {
          return (
            <Asset variant="main" key={i}>
              <Header>
                <ProjectData>
                  <UserAvatar
                    avatar={imageLoader("/88302.84503470722_img3.jpg")}
                    size="otc"
                    variant="success"
                    rating={item.rating}
                    name={item.name}
              ...
              <PriceInfo>
                <div className="info">
                  <div className="key">Invested</div>
                  <div className="value">${clarifyAmount(item.invested)}</div>
                </div>
                <div className="info">
                  <div className="key">Current Balance</div>
                  <div className="value">${clarifyAmount(item.balance)}</div>
                </div>
              </PriceInfo>
            </Asset>
          );
...
export default FomiesPortfolios;
