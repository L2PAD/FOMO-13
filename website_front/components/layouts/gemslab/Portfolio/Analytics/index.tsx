...
import { GemsLabProjectsShort } from "../../../../../staticContent/gemslab";
      ...
      <ContentWrapper>
        <ActionsWrapper>
          <ButtonsWrapper>
            ...
            <DeleteButton>Delete assets</DeleteButton>
          </ButtonsWrapper>
          <div>
            <DropdownWrapper
              label="Sort by"
        ...
        <TableWrapper>
          <ViewTable
            ...
            cardsData={{
              //@ts-ignore
              cards: GemsLabProjectsShort.map((item) => ({
                ...item,
                onClick: () => router.push("/gemslab/project/123"),
              })),
            }}
          />
          <Pagination
