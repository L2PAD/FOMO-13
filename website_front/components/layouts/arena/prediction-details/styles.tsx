...
export const OutcomesHeader = styled.div`
  ...
  @media (max-width: 768px) {
    grid-template-columns: 0.4fr 85px 0.6fr;
    gap: 0;
  }
`;
...
export const OutcomeRow = styled.div<{ selected?: boolean }>`
  ...
  @media (max-width: 768px) {
    height: auto;
    grid-template-columns:  0.3fr 60px 0.6fr;
  }
...
export const BetOptionButton = styled.button<{
  ...
  ${({ variant, active }) =>
    variant === "yes"
      ? `
    background: ${active ? "var(--color-primary)" : "#F5FBFD"};
  ...
  `
      : `
    background: ${active ? "var(--color-danger)" : "#FEF1F2"};
    color: ${active ? "var(--color-white)" : "var(--color-danger)"};
