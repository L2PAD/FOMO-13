...
import { CoinGeckoMarketUniverseDryRunService } from "./services/coingecko-market-universe-dry-run.service";
...
@Module({
  ...
  providers: [CoinGeckoProClientService, CoinGeckoMarketUniverseDryRunService],
})
export class FomoV2DryRunCliModule {}
